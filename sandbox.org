...
that balances between annoying prompts from those where I want the agent to wait and confirm.

** Setup

There are many ways to do this. You can isolate your agent with [[https://nono.sh][kernel-backed]] solutions like
[[https://landlock.io][landlock]], [[https://github.com/containers/bubblewrap][bubblewrap]], [[https://theapplewiki.com/wiki/Dev:Seatbelt][seatbelt]] and skip all permissions. Or, you can side step all the [[https://nono.sh/docs/cli/clients/claude-code][capability
management]] and run your agent in a virtual machine isolated from all that matters to you. Or you
can, like I did, mix things up to fit your personal workflow.

If you are on a recent Mac (Apple Silicon, macOS Tahoe) with the [[https://github.com/apple/container][=container=]] CLI installed, you can
...
With the sandbox in place, most permission prompts disappear. I still see one when the agent wants
to reach a new domain or do something unexpected. Those are the prompts I want to review, at least
until I am cool enough for the =--dangerously-skip-permissions= world we're heading towards.
